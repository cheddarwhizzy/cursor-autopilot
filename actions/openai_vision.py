...
def is_chat_waiting_for_input(screenshot_path):
    """
    Uses OpenAI Vision API to check if the chat window is waiting for user input.
    ...
    try:
                ...
                messages=[
                    {
                        ...
                        "content": [
                            {
                                "type": "text",
                                "text": "Is the chat window in this screenshot waiting for user input? Look for a blinking cursor, input field, or other indicators that the chat is ready for user input. Answer with just 'yes' or 'no'."
                            },
                            {
                                "type": "image_url",
                                "image_url": {
        ...
        logger.error(f"Error checking chat window state: {e}")
        return False
