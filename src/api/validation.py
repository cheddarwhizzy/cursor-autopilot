...
class ConfigValidator:
    ...
    GENERAL_SCHEMA = {
        ...
        "regular_keystroke_interval": {
            ...
            "min": 5,
            "max": 300,
            "description": "Seconds between regular keystroke sends (global default)",
        },
        "debug": {"type": bool, "description": "Enable debug logging"},
        "active_platforms": {
            "type": list,
            "items": str,
            "valid_values": [
    ...
    PLATFORM_SCHEMA = {
        ...
        "regular_keystroke_interval": {
            ...
            "min": 5,
            "max": 300,
            "description": "Seconds between regular keystroke sends",
        },
